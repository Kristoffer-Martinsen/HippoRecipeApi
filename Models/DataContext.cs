    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Recipe>()
            ...
            .UsingEntity<Dictionary<string, object>>(
                ...
                j => j.HasOne<Recipe>().WithMany().HasForeignKey("RecipesId"),
                j =>
                {
                    j.HasData(
                        new { RecipesId = 1, TagsId = 1 },
                        new { RecipesId = 1, TagsId = 2 },
                        new { RecipesId = 1, TagsId = 3 }
                    );
                }
        ...
        modelBuilder.Entity<Tag>().HasData(
            new Tag { Id = 1, TagName = "Pasta" },
            new Tag { Id = 2, TagName = "Lunsj" },
            new Tag { Id = 3, TagName = "Middag" }
        );
    }
